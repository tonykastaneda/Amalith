...
pub(in crate::app) fn paint_main(
    ...
    cmyk_profile: Option<&crate::colormanage::CmykProfile>,
    ...
    layer_thumbnail_size: crate::prefs::LayerThumbnailSize,
    layer_thumbnail_contents: crate::prefs::LayerThumbnailContents,
