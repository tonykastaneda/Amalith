...
export default function Docs() {
  return (
    <>
      ...
      <footer>
        <a className="footer-brand" href={`${basePath}/`} aria-label="Amalith home"><img src={`${basePath}/brand/amalith-a.svg`} alt="" /></a>
        <div className="footer-links">
          <div><p>Project</p><a href={`${basePath}/why/`}>Why Amalith</a><a href={`${basePath}/#why`}>Features</a><a href={`${basePath}/#status`}>News</a><a href={`${basePath}/docs/`}>Docs</a></div>
        ...
        <p className="footer-note">Built in public. Made for designers. <span className="footer-heart" aria-label="love">♥</span> from Bell, California.</p>
      </footer>
    </>
  );
}
